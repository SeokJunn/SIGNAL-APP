...
public class IndexAdapterMemo extends ArrayAdapter<ProfileModel> {
    private LayoutInflater inflater;
    private SparseArray<WeakReference<View>> viewArray;

    public IndexAdapterMemo(Context ctx, int txtViewId, List<ProfileModel> models) {
    ...
    public View getView(int position, View cView, ViewGroup pView) {
        ...
        try {
            cView = inflater.inflate(R.layout.activity_tab3_item, pView, false);

            ImageView profileView = (ImageView) cView.findViewById(R.id.tab3_profile_image);
            TextView nameView = (TextView) cView.findViewById(R.id.tab3_name);
            TextView chatView = (TextView) cView.findViewById(R.id.tab3_chat);
            TextView timestampView = (TextView) cView.findViewById(R.id.tab3_timestamp);
